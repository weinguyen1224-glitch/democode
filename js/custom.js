(() => {
  ...
  document.body.insertAdjacentHTML('beforeend', '<div class="scene-progress" aria-hidden="true"></div>');
  ...
  function update() {
    ...
    const activeRatio = clamp((innerHeight - rect.top) / (innerHeight + rect.height));
