(() => {
  ...
  var c = k((W, R) => {
    (function (t) {
      ...
      function G(l) {
        l.scheduled ||
          ((l.scheduled = !0), l.raf(B.bind(null, l)), a("flush scheduled"));
      }
      ...
      function B(l) {
        ...
        var h = l.writes,
          ...
          n;
        try {
          (a("flushing reads", e.length),
            l.runTasks(e),
            a("flushing writes", h.length),
            l.runTasks(h));
        } catch (I) {
          n = I;
        }
  ...
  var U,
    Y,
    F =
      (Y = (U = window.__currentScript) == null ? void 0 : U.getRootNode()) !=
      null
        ? Y
        : document;
